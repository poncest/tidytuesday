...
## Challenge: #TidyTuesday 2026 week 38
## Data:      Average share of green areas across cities (UN-Habitat Urban Indicators)
## Author:    Steven Ponce
## Date:      2026-09-21
...
fig_w      <- 8.5
fig_h      <- 10.5
out_file   <- "2026/Week_38/2026_38.png"
...
### |-  preview ----
set.seed(38)
p + ggview::canvas(width = fig_w, height = fig_h, units = "in", dpi = 320)
