...
g +
    ...
    # labs
     labs(
        ...
        subtitle = "A power purchase agreement (PPA) is a contractual agreement between energy buyers and sellers. They come together and agree to buy and sell \nan amount of energy which is or will be generated by a renewable asset. PPAs are usually signed for a long-term period between 10-20 years.",
        caption = paste0(
