...
## Challenge: #TidyTuesday 2022 week 16
## Author: Steven Ponce
## Date: 2022-04-19
...
## 2. Read in the data ----
tt <- tidytuesdayR::tt_load(2022, week = 16)
data <- tt$big_dave %>% clean_names()
# rm(tt)

# OFFLINE - In case of VPN issues
# data <- write_csv(data, '2022/Week_16/big_dave.csv')
...
## 6. Save final figure ----
ggsave('2022/Week_16/2022_16_big_dave.png',
